...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'smackjeeves-dld-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('smackjeeves-item: %(item_name)s'),
        ...
        if item_type == 'comic':
            ...
            wget_args.extend(['--warc-header', 'smackjeeves-user: ' + item_value])
            wget_args.append('https://www.smackjeeves.com/author/{}'.format(item_value))
        else:
